...
[![Release](https://img.shields.io/github/v/release/thomas-sievering/gchatctl?label=release)](https://github.com/thomas-sievering/gchatctl/releases)
[![CI](https://img.shields.io/github/actions/workflow/status/thomas-sievering/gchatctl/ci.yml?label=ci)](https://github.com/thomas-sievering/gchatctl/actions)
